    ...
    private function setSettings(): void
    {
        ...
        $this->configuration = array(
            ...
            "api"     => array(
                ...
                "api_attr_index"        => $this->getApiAttributeIndex()
            ),
            "options" => array(
...
?>
    ...
    private function getUrlParams(): string
    {
        ...
        if (!empty($config->limit) && !empty($this->api_limit) && is_numeric($this->api_limit) && $this->api_limit < 20 && $this->api_limit > 0) {
    ...
    /**
     * Gets the attribute index in the API response where the desired data is located
     *
     * @return int
     * @since 3.5.5
     * @todo Use the name of the attribute that contains the results instead of its position in the JSON object
     *
     */
    private function getApiAttributeIndex(): int
    {
        $map = [
            // "your.api.here" => 1,
        ];

        // The fallback value is 0
        return (int) ($map[$this->api_source] ?? 0);
    ...
    private function setLanguageStrings(): void
    {
        ...
        $this->language = array(
            ...
            "cam_field_apt" => $this->tt("cam_field_apt"),
